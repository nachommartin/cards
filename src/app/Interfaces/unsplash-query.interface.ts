...
export interface CoverPhotoTopicSubmissions {
    animals?:             TexturesPatternsClass;
    "textures-patterns"?: TexturesPatternsClass;
    wallpapers?:          TexturesPatternsClass;
}

export interface TexturesPatternsClass {
    status:      TexturesPatternsStatus;
    approved_on: Date;
}

export enum TexturesPatternsStatus {
    Approved = "approved",
}
